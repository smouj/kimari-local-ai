...
def test_version_bump():
    ...
    assert "0.1.42" in pyproject or "0.1.43" in pyproject, "pyproject.toml must have version >= 0.1.42"
    assert "0.1.42" in init or "0.1.43" in init, "__init__.py must have version >= 0.1.42"
