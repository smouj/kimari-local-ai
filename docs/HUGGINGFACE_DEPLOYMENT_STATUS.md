...
| Field | Value |
|-------|-------|
| **Repo version** | v0.1.62-alpha |
| **HF org card version** | v0.1.62-alpha |
| **Space version** | v0.1.62-alpha |
| **Gate** | BLOCKED |
...
- Framework version: v0.1.62-alpha
...
|------|---------|---------|
| 2026-05-13 | v0.1.62-alpha | SFT v1 first real short run, gate BLOCKED |
