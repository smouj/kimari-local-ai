...
| Field | Value |
|-------|-------|
| **Repo version** | v0.1.78-alpha |
| **HF org card version** | v0.1.78-alpha |
| **Space version** | v0.1.78-alpha |
| **Gate** | BLOCKED |
...
- Framework version: v0.1.78-alpha
...
| 2026-05-14 | v0.1.78-alpha | Private raw retrieval attempt; gate BLOCKED | | |
