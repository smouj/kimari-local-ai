...
> **Last reviewed: 2026-05-15** — Kimari Local AI public presence on Hugging Face.

## Current State

| Field | Value |
|-------|-------|
| **Repo version** | v0.1.82-alpha |
| **HF org card version** | v0.1.82-alpha |
| **Space version** | v0.1.82-alpha |
| **Gate** | BLOCKED |
...
- Framework version: v0.1.82-alpha
...
| 2026-05-14 | v0.1.82-alpha | Private raw retrieval attempt; gate BLOCKED | | |
