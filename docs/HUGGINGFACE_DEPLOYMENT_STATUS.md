...
| Field | Value |
|-------|-------|
| **Repo version** | v0.1.77-alpha |
| **HF org card version** | v0.1.77-alpha |
| **Space version** | v0.1.77-alpha |
| **Gate** | BLOCKED |
...
- Framework version: v0.1.77-alpha
...
| 2026-05-14 | v0.1.77-alpha | Private raw retrieval attempt; gate BLOCKED | | |
