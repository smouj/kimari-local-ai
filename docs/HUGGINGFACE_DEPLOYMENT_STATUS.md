...
| Field | Value |
|-------|-------|
| **Repo version** | v0.1.66-alpha |
| **HF org card version** | v0.1.66-alpha |
| **Space version** | v0.1.66-alpha |
| **Gate** | BLOCKED |
...
- Framework version: v0.1.66-alpha
...
| 2026-05-14 | v0.1.66-alpha | SFT v1 eval subset10 infrastructure, gate BLOCKED | | |
