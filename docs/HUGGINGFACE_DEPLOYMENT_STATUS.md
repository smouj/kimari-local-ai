...
| Field | Value |
|-------|-------|
| **Repo version** | v0.1.81-alpha |
| **HF org card version** | v0.1.81-alpha |
| **Space version** | v0.1.81-alpha |
| **Gate** | BLOCKED |
...
- Framework version: v0.1.81-alpha
...
| 2026-05-14 | v0.1.81-alpha | Private raw retrieval attempt; gate BLOCKED | | |
