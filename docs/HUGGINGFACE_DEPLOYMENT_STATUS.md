...
| Field | Value |
|-------|-------|
| **Repo version** | v0.1.87-alpha |
| **HF org card version** | v0.1.87-alpha |
| **Space version** | v0.1.87-alpha |
| **Gate** | BLOCKED |
...
- Framework version: v0.1.87-alpha
...
| 2026-05-14 | v0.1.83-alpha | Private raw retrieval attempt; gate BLOCKED | | |
