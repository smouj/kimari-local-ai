...
| Field | Value |
|-------|-------|
| **Repo version** | v0.1.76-alpha |
| **HF org card version** | v0.1.76-alpha |
| **Space version** | v0.1.76-alpha |
| **Gate** | BLOCKED |
...
- Framework version: v0.1.76-alpha
...
| 2026-05-14 | v0.1.76-alpha | Private raw retrieval attempt; gate BLOCKED | | |
