...
| Field | Value |
|-------|-------|
| **Repo version** | v0.1.58-alpha |
| **HF org card version** | v0.1.58-alpha |
| **Space version** | v0.1.58-alpha |
| **Gate** | BLOCKED |
...
- Framework version: v0.1.58-alpha
...
|------|---------|---------|
| 2026-05-13 | v0.1.58-alpha | Open-license base bakeoff status, public surface version sync |
