...
| Field | Value |
|-------|-------|
| **Repo version** | v0.1.64-alpha |
| **HF org card version** | v0.1.64-alpha |
| **Space version** | v0.1.64-alpha |
| **Gate** | BLOCKED |
...
- Framework version: v0.1.64-alpha
...
| 2026-05-14 | v0.1.64-alpha | SFT v1 result reconciliation + eval readiness, gate BLOCKED | |
