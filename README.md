...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.1.69--alpha-9b59b6.svg" alt="v0.1.69-alpha">
...
> **⚠️ Alpha Software** — Kimari Local AI is in active early development (v0.1.69-alpha). Expect rough edges, breaking changes between versions, and missing features. The project is usable today but not yet production-ready.
