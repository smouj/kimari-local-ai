...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-v0.1.34--alpha-9b59b6.svg" alt="v0.1.34-alpha">
...
> **⚠️ Alpha Software** — Kimari Local AI is in active early development (v0.1.34-alpha). Expect rough edges, breaking changes between versions, and missing features. The project is usable today but not yet production-ready.
...
> **Status: Planned / Training Design** — No weights released yet. SmolLM3-3B accepted for first private SFT candidate. v0.1.34-alpha — train_sft_lora.py supports real micro SFT training with LoRA/QLoRA
